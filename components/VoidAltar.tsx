...
interface VoidAltarProps {
  ...
  onRitual: (type: 'LUCK' | 'TRANSMUTE' | 'GREED' | 'CHAOS') => void;
}

export const VoidAltar: React.FC<VoidAltarProps> = ({ onClose, fatePoints, keys, activeBuff, onRitual }) => {
  ...
  const rituals = [
    ...
    },
    {
      ...
      cost: '20 Fate Points',
      desc: 'Gamble 20 Fate Points. If your NEXT roll is successful, receive 2 Keys instead of 1.',
      canAfford: fatePoints >= 20,
            ...
            {rituals.map((ritual) => {
                ...
                return (
                    <button
                        ...
                        onClick={() => onRitual(ritual.id as any)}
                        className={`
