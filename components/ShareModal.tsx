...
interface ShareModalProps {
  onClose: () => void;
  gameState: Pick<GameState, 'keys' | 'specialKeys' | 'chaosKeys' | 'fatePoints' | 'unlocks' | 'history'>;
}

type CardTheme = 'VOID' | 'GILDED' | 'IRON' | 'BLOOD';

export const ShareModal: React.FC<ShareModalProps> = ({ onClose, gameState }) => {
  ...
  const generateTextSummary = () => {
    return `📜 **Fate-Locked UIM** - ${rank.title}
        ...
        >
            ...
            <div className={`relative z-10 flex justify-between items-center p-6 border-b ${ts.deco}`}>
                <div className="flex items-center gap-5">
                    ...
                    <div>
                        <h2 className="text-3xl font-black text-white uppercase tracking-widest leading-none">Fate-Locked UIM</h2>
